...
$(function(){if(svg4everybody(),$(".js-open-popup-link").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom",closeMarkup:'<button title="%title%" type="button" class="mfp-close"></button>'}),$(".js-test-slider").slick({slidesToShow:3,autoplay:!0,autoplaySpeed:3e3,arrows:!0,dots:!1,appendArrows:$(".js-otdelka-slider-nav"),nextArrow:'<button type="button" class="slick-next"><svg class="icon-svg icon-13"><use xlink:href="images/sprite.svg#13"></use></svg></button>',prevArrow:'<button type="button" class="slick-prev"><svg class="icon-svg icon-14"><use xlink:href="images/sprite.svg#14"></use></svg></button>',responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:575,settings:{slidesToShow:1}}]}),$(".js-hp-cases-slider").slick({arrows:!0,dots:!1,slidesToShow:1,centerMode:!0,variableWidth:!0,nextArrow:'<button type="button" class="slick-next"><svg class="icon-svg icon-6"><use xlink:href="images/sprite.svg#6"></use></svg></button>',prevArrow:'<button type="button" class="slick-prev"><svg class="icon-svg icon-5"><use xlink:href="images/sprite.svg#5"></use></svg></button>'}),$(".js-hp-reviews-slider").slick({arrows:!0,dots:!1,slidesToShow:1,centerMode:!0,variableWidth:!0,nextArrow:'<button type="button" class="slick-custom slick-next"><svg class="icon-svg icon-6"><use xlink:href="images/sprite.svg#6"></use></svg></button>',prevArrow:'<button type="button" class="slick-custom slick-prev"><svg class="icon-svg icon-5"><use xlink:href="images/sprite.svg#5"></use></svg></button>',appendArrows:$(".js-hp-reviews-controls")}),$(".js-hp-options-slider").slick({arrows:!0,dots:!1,slidesToShow:3,nextArrow:'<button type="button" class="slick-custom slick-next"><svg class="icon-svg icon-6"><use xlink:href="images/sprite.svg#6"></use></svg></button>',prevArrow:'<button type="button" class="slick-custom slick-prev"><svg class="icon-svg icon-5"><use xlink:href="images/sprite.svg#5"></use></svg></button>',responsive:[{breakpoint:1023,settings:{slidesToShow:2}},{breakpoint:767,settings:{slidesToShow:1}}]}),$(".js-hp-journal-slider").slick({arrows:!0,dots:!0,slidesToShow:1,fade:!0,appendDots:$(".js-hp-journal-controls"),nextArrow:'<button type="button" class="slick-custom slick-next"><svg class="icon-svg icon-6"><use xlink:href="images/sprite.svg#6"></use></svg></button>',prevArrow:'<button type="button" class="slick-custom slick-prev"><svg class="icon-svg icon-5"><use xlink:href="images/sprite.svg#5"></use></svg></button>'}),$(".js-radio-select").on("mouseover",function(){$(this).addClass("active")}),$(".js-radio-select").on("mouseout",function(){$(this).removeClass("active")}),$(".js-radio-select-option").click(function(s){s.preventDefault();var e=$(this).parent(),t=$(this);$(e).find("input").attr("checked",!1),$(t).find("input").attr("checked",!0),$(e).find(".js-radio-select-option.active").removeClass("active"),$(t).addClass("active")}),$(".js-cmn-faq-question").click(function(){$(this).parent().toggleClass("active")}),$(".js-hp-choice-item .hp-choice__item-title").click(function(){$(this).parent().toggleClass("active")}),$(".js-sticky-faq-elem").length&&$(window).width()>=1024){var s=new Sticky(".js-sticky-faq-elem");$(".cmn-faq__questions").click(function(){s.update()})}(new WOW).init()});